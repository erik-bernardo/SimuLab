...
const WORD_BANK = [
    ...
    ["Avô", "Avo", "Ávo", "Regra: Oxítonas terminadas em A, E, O (seguidas ou não de S) são acentuadas."],
    ...
    ["Órgão", "Orgão", "Ôrgão", "Regra: Paroxítonas terminadas em ÃO são acentuadas."],
    ...
    ["País", "Pais", "Páis", "Regra: Acentua-se I e U tônicos quando sozinhos ou seguidos de S, formando hiato."],
    ["Baú", "Bau", "Báu", "Regra: Acentua-se I e U tônicos quando sozinhos ou seguidos de S, formando hiato."],
